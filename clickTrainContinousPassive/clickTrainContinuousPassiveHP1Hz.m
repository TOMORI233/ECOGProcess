...
for pos = 1 : 2
    ...
    for blks = 1:length(allBlocks)
        ...
        if ~exist(fullfile(DATAPATH,strcat(posStr(posIndex), '_filterResHP1Hz.mat')),"file") || reprocess
            ...
            save(fullfile(DATAPATH,strcat(posStr(posIndex), '_filterResHP1Hz.mat')), 'filterRes', '-mat');
        end
        %%
        close all;
    end
