        ...
        for pN = 1 : length(paradigmKeyword)
            for pos = posIndex
                ...
                for stimCode = 1 : length(filterRes)
                    clearvars -except monkeyId id savePath savePath2 recordCode  matPath selectWin reprocess selectRecord posStr pos posIndex pos stimCode paradigmKeyword paradigmStr pN filterRes rootPath cdrRes cdrPlot plotFigure dateStr plotCh chMeanSel yScale s1OnsetOrS2Onset plotMultiFigure
                    % get data
