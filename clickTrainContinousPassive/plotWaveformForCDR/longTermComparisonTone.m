...
paradigmKeyword = "Tone";


%

load("E:\ECoG\matData\chouchou\cc20220720\Block-4_ClickTrainSSALongTermTone4ms\LAuC_filterResHP0o1Hz.mat");
LAuC_FilterRes = filterRes;
load("E:\ECoG\matData\chouchou\cc20220720\Block-4_ClickTrainSSALongTermTone4ms\LPFC_filterResHP0o1Hz.mat");
LPFC_FilterRes = filterRes;
savePath = fullfile("E:\ECoG\corelDraw\jpgHP0o1Hz", "freq band response comparison", "cc20220720", "Tone") ;
paradigmStr = 'Tone';
% figure settings;
margins = [0.02,0.02,0.06,0.06];
paddings = [0.01, 0.01, 0.02, 0.02];
% raw data
tempReg1Ord = LAuC_FilterRes(3);
tempReg2Ord = LPFC_FilterRes(3);
tempReg1Rev = LAuC_FilterRes(4);
tempReg2Rev = LPFC_FilterRes(4);

tempIrreg1Ord = LAuC_FilterRes(1);
tempIrreg2Ord = LPFC_FilterRes(1);
tempIrreg1Rev = LAuC_FilterRes(2);
tempIrreg2Rev = LPFC_FilterRes(2);
