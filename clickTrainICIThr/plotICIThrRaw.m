                        ...
                        case "MMNData.mat"
                            ...
                            for dIndex = 1 : length(MMNData)
                                ...
                                if dIndex == 1
                                    ...
                                    MMN_Wave = plotRawWave2(MMN_Wave, MMNData(dIndex).chMeanDEV - MMNData(dIndex).chMeanLastSTD, [], MMNData(dIndex).window, colors(dIndex));
                                    devCompare_Wave = plotRawWave2(devCompare_Wave, MMNData(dIndex).chMeanDEV, [], MMNData(dIndex).window, colors(dIndex));
                                end
