function [H, Z, S, psi] = sfactorization2x2_time_hm(S,freq,Niterations,tol,cmbindx,fb,init,checkflag,stabilityfix)
% S: complex double
% I: double
% Sarr: complex double
N    = numel(freq);
...
for iter = 1:Niterations
    ...
    gp     = PlusOperator2x2(g,m,N); %gp constitutes positive and half of zero lags % complex double
