...
print(FigPE1, strcat(PEPATH, AREANAME, "_PE_Raw_", DateStr), "-djpeg", "-r200");

for dIndex = 1:length(FigPE2)
...
print(FigPush1, strcat(PUSHPATH, AREANAME, "_Push_Raw_", DateStr), "-djpeg", "-r200");

for dIndex = 1:length(FigPush2)
