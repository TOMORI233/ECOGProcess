close all; clc; clear;
MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\TB\Add_on_Control_BaseICI_12_16\cc20230505\';
% MATPATH{2} = 'E:\ECoG\MAT Data\XX\ClickTrainLongTerm\TB\Add_on_Control_BaseICI_12_16\xx20230504\';
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "Ex_Sfigure15_Add_on_Control_BaseICI_12-16\", dateStr, "\");
    mkdir(FIGPATH);
