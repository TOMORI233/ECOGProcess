...
if monkeyId == 1
    MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\Successive_0o3_0o5\cc20220930\cc20220930_AC.mat';
    MATPATH{2} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\Successive_0o1_0o2\cc20221004\cc20221004_AC.mat';
    MATPATH{3} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\Successive_0o025_0o05\cc20221011\cc20221011_AC.mat';
elseif monkeyId == 2
    MATPATH{1} = 'E:\ECoG\MAT Data\XX\ClickTrainLongTerm\Successive_0o3_0o5\xx20220929\xx20220929_AC.mat';
    MATPATH{2} = 'E:\ECoG\MAT Data\XX\ClickTrainLongTerm\Successive_0o1_0o2\xx20220927\xx20220927_AC.mat';
    MATPATH{3} = 'E:\ECoG\MAT Data\XX\ClickTrainLongTerm\Successive_0o025_0o05\xx20221011\xx20221011_AC.mat';
end
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "\Figure6\", DateStr{1}, "\", SRIMethodStr(SRIMethod), "\", stimStrs(stimSelect), "\");
    mkdir(FIGPATH);
    ...
    for dIndex = 1:length(devType)
        ...
        [ff_Spon_Temp, PMean_Spon_Temp, trialsFFT_Spon]  = trialsECOGFFT(trialsECOG, fs, tIdx, [], FFTMethod);
        ...
        [H, P] = waveFFTPower_pValue(trialsFFT, trialsFFT_Spon, [{ff}, {ff_Spon_Temp}], targetIndex, 2);
