function CTLParams = ME256_ParseOffsetParams(protStr)
% parse monkey ecog species click train longterm parameters

% load excel
configPath = strcat(fileparts(mfilename("fullpath")), "\ME256_Config.xlsx");
...
CTLParams.stimStrs = strrep(string(strsplit(mProtocol.trialTypes, ",")), "_", "_");
