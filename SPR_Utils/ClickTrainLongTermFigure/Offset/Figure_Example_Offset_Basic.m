...
% chs2doICA = 1 : size(trialsECOG_MergeTemp{1}, 1);
% chs2doICA(chExclude) = [];
% 
...
for gIndex = 1 : length(group_Index)
    ...
    FigGroup(gIndex) = plotRawWaveMulti_SPR(chPlot, Window, group_Str(gIndex));
    ...
    FigGroupS1(gIndex) = plotRawWaveMulti_SPR(chPlotS1, Window, group_Str(gIndex));
