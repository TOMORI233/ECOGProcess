...
if monkeyId == 1
    MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\TITS_Offset_SPL\cc20221108\cc20221108_AC.mat';
...
fhp = 0.1;
flp = 10;
stimStrs = ["Reg30_0o1", "Reg30_0o2", "Reg30_0o4", "Reg30_0o7", "Reg30_1", "Reg60_0o1", "Reg60_0o2", "Reg60_0o4", "Reg60_0o7", "Reg60_1", ];

protStr = "TITS_Offset_SPL";
...
sponWin = [-300 0];
latencyWin = [80 200];
baseICI = [30, 30, 30, 30, 30, 60, 60, 60, 60, 60];
ICI2 = baseICI;
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "Figure5_Offset_SPL\", dateStr, "\", AREANAME, "\");
    mkdir(FIGPATH);
    %% process
    tic
...
for dIndex = devType
    ...
    for mIndex = 1 : length(MATPATH)
        ...
        scaleAxes([FigWave, FigWaveFilted], "x", [-1000 1000]);
