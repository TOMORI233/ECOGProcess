...
if monkeyId == 1
    MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\TITS_Offset_15_DiffRep\cc20221110\cc20221110_AC.mat';
...
fhp = 0.1;
flp = 10;
stimStrs = ["Reg15_Rep0", "Reg15_Rep3", "Reg15_Rep6", "Reg15_Rep9", "Reg15_Rep12", "Irreg15_Rep1", "Irreg15_Rep2", "Irreg15_Rep3", "Irreg15_Rep4", "Irreg15_Rep5"];
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "Figure5_TITS_Offset_15_DiffRep\", dateStr, "\", AREANAME, "\");
    mkdir(FIGPATH);
    %% process
    tic
