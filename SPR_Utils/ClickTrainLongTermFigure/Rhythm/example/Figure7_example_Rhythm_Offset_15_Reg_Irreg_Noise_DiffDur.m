...
if monkeyId == 1
    MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\TITS_Offset_15_Reg_Irreg_Noise_DiffDur\cc20221112\cc20221112_AC.mat';
...
fhp = 0.1;
flp = 10;
stimStrs = ["Reg15_250ms", "Reg15_500ms", "Reg15_1000ms", "Reg15_2000ms", "Reg15_4000ms", ...
...
protStr = "TITS_Offset_15_DiffRep";
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "Figure7_TITS_Offset_15_Reg_Irreg_Noise_DiffDur\", dateStr, "\", AREANAME, "\");
    mkdir(FIGPATH);
    %% process
    tic
