...
if monkeyId == 1
    MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\TITS_Offset_15_Reg_Irreg_Noise_DiffDur_500_1000ms\cc20221114\cc20221114_AC.mat';
...
fhp = 0.1;
flp = 10;
stimStrs = ["Reg15_500ms", "Reg15_750ms", "Reg15_1000ms", ...
            "Irreg15_500ms", "Irreg15_750ms", "Irreg15_1000ms",...
            "Noise_500ms", "Noise_750ms", "Noise_1000ms"];
protStr = "TITS_Offset_15_Reg_Irreg_Noise_DiffDur_500_1000ms";
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "Figure7_TITS_Offset_15_Reg_Irreg_Noise_DiffDur_500_1000ms\", dateStr, "\", AREANAME, "\");
    mkdir(FIGPATH);
    %% process
    tic
