...
if monkeyId == 1
    MATPATH{1} = 'E:\ECoG\MAT Data\CC\ClickTrainLongTerm\TITS_Offset_30_DiffRep\cc20221110\cc20221110_AC.mat';
...
fhp = 0.1;
flp = 10;
stimStrs = ["Reg30_Rep0", "Reg30_Rep3", "Reg30_Rep6", "Reg30_Rep9", "Reg30_Rep12", "Irreg30_Rep1", "Irreg30_Rep2", "Irreg30_Rep3", "Irreg30_Rep4", "Irreg30_Rep5"];        

protStr = "TITS_Offset_30_DiffRep";
...
for mIndex = 1 : length(MATPATH)
    ...
    FIGPATH = strcat(ROOTPATH, "Figure5_TITS_Offset_30_DiffRep\", dateStr, "\", AREANAME, "\");
    mkdir(FIGPATH);
    %% process
    tic
